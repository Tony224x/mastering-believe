# Communication & Persuasion — Convaincre honnetement

> **Pilier** : Relations · **Ecole de la vie** · `mastering-believe`

---

## Pourquoi ce domaine ?

Savoir communiquer clairement et persuader de facon honnete est un **levier transversal** : il sert dans *toutes* les spheres de la vie — travail, relations intimes, sante, finances, citoyennete. Ce n'est pas un "truc de vendeur" ; c'est la capacite a **exprimer un besoin avec precision, ecouter vraiment, structurer un argument solide et negocier un accord juste**.

Le 20 % qui donne 80 % des resultats (Pareto-first) :
1. **Ecouter d'abord** — l'autre se sent compris avant d'etre convaincu.
2. **Clarte** — un message simple et concret bat un message "complet" mais confus.
3. **Ethos + Pathos + Logos** — on ne convainc pas avec des faits seuls.
4. **Interet commun** — negocier sur les interets, pas les positions.

---

## Charte ethique CTR

**Ce domaine enseigne la persuasion honnete, pas la manipulation.**

Avant toute tentative de persuasion, verifier les 3 garde-fous :

| Garde-fou | Question a se poser |
|-----------|---------------------|
| **C — Consentement** | L'autre peut-il dire non sans cout cache ni piege ? |
| **T — Transparence** | Mes intentions et tous les faits materiels sont-ils visibles ? |
| **R — Reciprocite honnete** | L'accord vise-t-il un benefice mutuel reel ? |

**Hors-scope total** : dark patterns, techniques de manipulation coercitive, contenus PUA, spin politique, desinformation, fausse rarete / fausse autorite, pression abusive.

---

## Prerequis

Aucun. Ce domaine est accessible a toute personne souhaitant ameliorer sa communication, quel que soit son niveau ou son parcours.
