...
**Retour d'experience terrain** : sur un agent RAG multi-sources (3 retrievers), passer de sequentiel a parallel asyncio fait passer la latence de 12s a 4s — 3x de gain sans changer la qualite. C'est le plus gros gain de latence pour la plus petite modification de code.
