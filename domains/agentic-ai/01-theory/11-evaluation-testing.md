...
```
Tache : "Quel est le CA de Acme en 2025 ?"
Reponse attendue : "820 000 euros"

Agent run →  "Acme a realise un chiffre d'affaires de 820k euros en 2025."
...
User : Task: "Find the revenue of Acme in 2025"
       Expected: The answer should mention a number close to 820k euros.
       Actual : "Acme made about 820k euros in revenue in 2025."
...
**Retour d'experience terrain** : on utilise typiquement **Ragas** pour tous les RAG agentiques (les metriques natives couvrent 90% des besoins), **DeepEval** pour les agents generaux, et **Phoenix** pour le monitoring continuous en prod. Le pytest maison est garde uniquement pour les smoke tests ultra-rapides en dev.
