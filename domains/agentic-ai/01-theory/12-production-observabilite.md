...
**Recommandation Kalira** : Langfuse en demarrage (friction minimale), Arize Phoenix quand on passe a l'echelle production avec eval heavy. LangSmith si on est deja dans l'ecosysteme LangChain.
