...
> **Opinion Kalira** : en interne, on garde LangGraph comme default sur les workers production (flexibilite, checkpointing) et Pydantic AI sur les nouvelles features ou la type safety est critique. Claude Agent SDK est notre pick pour les POCs premium.
