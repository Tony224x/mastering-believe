...
On paie cher **seulement** la ou le raisonnement est critique (le plan et les decisions hautes), et on passe a un modele cheap pour l'execution mecanique des steps. **Retour d'experience terrain** : cette strategie divise le cout par 4 sans degrader la qualite du livrable final.
