...
**Nom** : AcmeResearcher
**Utilisateur cible** : consultant IA fictif (entreprise Acme) qui doit produire des rapports courts sur des sujets techniques ou marche.
...
1. **Simple** : "Quelles sont les forces de Acme en 2025 ?" — attendre une reponse contenant "conseil IA" et "saas"
2. **Composee** : "Compare Acme et son principal concurrent en terme de CA et de positionnement" — attendre "Artefact" et des chiffres
...
1. `Corpus` — mini base de 10 documents Acme
...
9. `AcmeResearcher` — la classe principale qui orchestre tout
