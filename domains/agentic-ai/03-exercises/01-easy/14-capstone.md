...
3. Modifie `KaliraResearcher` pour inserer l'etape critic **apres** le writer et **avant** les guardrails output
...
- [ ] `KaliraResearcher` appelle le critic dans le bon ordre
...
### Consigne
1. Cree une nouvelle classe `SwarmKaliraResearcher` qui remplace `KaliraResearcher`
...
### Criteres de reussite
- [ ] `SwarmKaliraResearcher` n'utilise pas de `SupervisorAgent`
