...
Trois problemes d'architecture que tu peux rencontrer chez LogiSim. Chaque projet est fourni sous forme de **cahier des charges** + **solution detaillee avec diagrammes ASCII**, parce que le livrable d'un exercice system design n'est pas du code mais un document d'architecture.
...
| 02 | **Pipeline EOD (End-of-Day Review)** | event sourcing, time-series, indexation, replay | medium |
