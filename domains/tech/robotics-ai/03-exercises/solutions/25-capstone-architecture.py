...
Imports the J25 architecture from `domains/tech/robotics-ai/02-code/25-capstone-architecture.py`.
"""
...
DOMAIN_ROOT = THIS_FILE.parents[2]            # .../domains/tech/robotics-ai
