...
Usage:
    python domains/tech/robotics-ai/03-exercises/solutions/24-capstone-setup.py [easy|medium|hard|all]
...
def load_dataset(data_dir: Path = DATA_DIR):
    ...
    if not (data_dir / "data.npz").exists():
        raise FileNotFoundError(
            ...
            "  python domains/tech/robotics-ai/02-code/24-capstone-setup.py"
        )
