...
Phase 2 : EXCHANGE (barrier : master attend tous les DONE)
  ...
  worker :
    ...
    - resout les events cross-zone (hand-off, operation a la frontiere)
...
- **HLA/DIS natif** — les normes IEEE 1516 / 1278 font deja le lockstep. LogiSim les supporte deja en realite. Pour un exo pedagogique, construire from scratch est instructif.
