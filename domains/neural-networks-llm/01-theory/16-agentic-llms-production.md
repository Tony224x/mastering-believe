...
Utilise dans des systemes multi-agent complexes. Le supervisor route vers un specialiste, qui peut re-router via le swarm. Cf `domains/agentic-ai/02-code/` et le projet guide supervisor-swarm-multi-tier dans ce repo.
