...
- [ ] P(E) = 0,10 × 0,60 + 0,60 × 0,40 = 0,06 + 0,24 = 0,30 est calcule
...
- [ ] Etape 1 : P(MR | 1ere rouge) = (0,80 × 0,50) / (0,80 × 0,50 + 0,30 × 0,50) = 0,40 / 0,55 ≈ **72,7 %**
- [ ] Etape 2 : P(MR | 2eme rouge) ≈ (0,80 × 0,727) / (0,80 × 0,727 + 0,30 × 0,273) ≈ 0,582 / 0,664 ≈ **87,7 %**
- [ ] Etape 3 : P(MR | 1 bleue) ≈ (0,20 × 0,877) / (0,20 × 0,877 + 0,70 × 0,123) ≈ 0,1754 / 0,2615 ≈ **67,1 %**
- [ ] La verification par calcul global donne le meme resultat (~67 %)
- [ ] Conclusion : la mise a jour sequentielle est equivalente a la mise a jour globale — l'ordre des preuves n'importe pas pour le resultat final
...
Un ami vous presente deux tests pour detecter si un joueur de poker mente (bluff) :
...
**Question 3** : Si votre prior sur le bluff est P(bluff) = 0,25 (1 chance sur 4 que le joueur bluffe), calculez le posterior apres avoir observe "tape la table" avec le test A (utilisez la forme odds).
...
- [ ] Question 3 : Odds prior = 0,25 / 0,75 = 1/3 ; Odds posterior = (1/3) × 2,33 ≈ 0,78 ; P(bluff|tape) = 0,78 / 1,78 ≈ **43,7 %**
- [ ] Interpretation : l'observation augmente la probabilite de bluff de 25 % a ~44 %, mais ne la rend pas certaine
