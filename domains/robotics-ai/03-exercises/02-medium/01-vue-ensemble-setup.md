...
## Objectif
Faire tourner un env MuJoCo (`HalfCheetah-v5`) avec une policy aléatoire, collecter des stats par épisode, et calculer la **reward moyenne** sur 5 épisodes — référence à laquelle on comparera plus tard les algos appris.

## Consigne
Écris un script `medium.py` qui :

1. Crée `HalfCheetah-v5` (nécessite `gymnasium[mujoco]` et `mujoco`).
...
- 5 épisodes tournent sans crash sur HalfCheetah-v5.
