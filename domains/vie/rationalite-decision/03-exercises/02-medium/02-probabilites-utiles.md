...
*Conseil : le script `domains/vie/rationalite-decision/02-code/02-probabilites-utiles.py` calcule VPP et VPN a partir de sensibilite/specificite/prevalence — utilisez-le pour verifier.*
